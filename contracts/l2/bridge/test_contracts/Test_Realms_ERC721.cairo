...
@storage_var
func l2_bridge_contract_address() -> (address: felt):
end

@external
func set_l2_bridge_contract_address{
        syscall_ptr: felt*,
        pedersen_ptr: HashBuiltin*,
        range_check_ptr
    }(
    ...
    l2_bridge_contract_address.write(new_address)
...
# Do owner check without asserting
@external
func bridge_token_check{
        syscall_ptr: felt*,
        pedersen_ptr: HashBuiltin*,
        range_check_ptr
    }(
