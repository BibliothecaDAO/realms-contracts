...
### Loot - Loot Items and Characters contracts on Starknet.

This folder contains the code to bring Loot items to Starknet for use in the settling game.

**This folder contains Loot Cairo contracts. If you're looking for another contract, please see the [directory of our Realms Smart Contracts](/).**

### Loot contract overview

| Module          | Function                             | Current Status |
| --------------- | ------------------------------------ | -------------- |
| [CharacterBase](./CharacterBase.cairo)        | Characters that can equip Loot items | In review      |
| [ItemBase](./ItemBase.cairo)       | Individual Loot items         | In review      |
...
```
nile compile contracts/loot/CharacterBase.cairo
```
