...
struct Item {
    ...
    Slot: felt,  // weapon, head, chest, etc
    Type: felt,  // weapon.blade, armor.metal, jewlery.ring
    Material: felt,  // the material of the item
    Rank: felt,  // 1 is best (Divine Robe = 1, Silk Robe = 2, Linen Robe = 3, Robe = 4, Shirt = 5)
    Prefix_1: felt,  // First part of the name prefix (i.e Demon)
    Prefix_2: felt,  // Second part of the name prefix (i.e Grasp)
    Suffix: felt,  // Stored value if item has a Suffix (i.e of Power)
    Greatness: felt,  // Item greatness
    CreatedBlock: felt,  // Timestamp of when item was created
    XP: felt,  // Experience of the item
    Adventurer: felt,  // Adventurer ID IF equiped
