...
from contracts.settling_game.utils.interfaces import IModuleController, IB01_Settling
...
func settle{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(token_id : Uint256):
    ...
    IB01_Settling.set_time_staked(settle_state_address, token_id, block_timestamp)
