...
from contracts.settling_game.utils.interfaces import (
    IModuleController, IB02_Resources, IB01_Settling)
...
func claim_resources{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
    ...
    let (r_1) = IB02_Resources.get_resource_level(
        contract_address=resources_state_address,
        token_id=token_id,
        resource=realms_data.resource_1)
    let (r_2) = IB02_Resources.get_resource_level(
        contract_address=resources_state_address,
        token_id=token_id,
        resource=realms_data.resource_2)
    let (r_3) = IB02_Resources.get_resource_level(
        contract_address=resources_state_address,
        token_id=token_id,
        resource=realms_data.resource_3)
    let (r_4) = IB02_Resources.get_resource_level(
        contract_address=resources_state_address,
        token_id=token_id,
        resource=realms_data.resource_5)
    let (r_5) = IB02_Resources.get_resource_level(
        contract_address=resources_state_address,
        token_id=token_id,
        resource=realms_data.resource_5)
    let (r_6) = IB02_Resources.get_resource_level(
        contract_address=resources_state_address,
        token_id=token_id,
        resource=realms_data.resource_6)
    let (r_7) = IB02_Resources.get_resource_level(
        contract_address=resources_state_address,
        token_id=token_id,
    ...
    # get time staked
    let (time_staked) = IB01_Settling.get_time_staked(settling_state_address, token_id)
...
func upgrade_resource{
    ...
    let (level) = IB02_Resources.get_resource_level(resources_state_address, token_id, resource)

    let (upgrade_cost) = IB02_Resources.get_resource_upgrade_cost(
    ...
    # increase level
    IB02_Resources.set_resource_level(resources_state_address, token_id, resource, level + 1)
...
func fetch_resource_upgrade_ids{
    ...
    let (local data) = IB02_Resources.get_resource_upgrade_ids(resources_state_address, resource_id)
