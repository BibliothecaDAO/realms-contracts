...
func constructor{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
    ...
    let ( calculator_address ) = IModuleController.get_module_address(
        contract_address=address_of_controller, module_id=ModuleIds.L04_Calculator)
    ...
    let ( wonders_state_address ) = IModuleController.get_module_address(
        contract_address=address_of_controller, module_id=ModuleIds.S05_Wonders)
    IS05_Wonders.set_last_updated_epoch(wonders_state_address, current_epoch )
...
func claim_wonder_tax{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
    ...
    let ( wonders_state_address ) = IModuleController.get_module_address(contract_address=controller, module_id=ModuleIds.S05_Wonders)
    let ( calculator_address ) = IModuleController.get_module_address(contract_address=controller, module_id=ModuleIds.L04_Calculator)
...
func update_epoch_pool{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}():
    ...
    if epochs_to_update == 0:
        ...
        IS05_Wonders.set_total_wonders_staked(wonders_state_address, updating_epoch + 1, total_wonders_staked) 
