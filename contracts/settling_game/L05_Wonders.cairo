...
from contracts.settling_game.utils.interfaces import (
    IModuleController, I02B_Resources, IS01_Settling, I01A_Settling, I04A_Calculator, IS05_Wonders)
...
func pay_wonder_upkeep{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
    ...
    IS05_Wonders.set_wonder_epoch_upkeep(epoch=epoch, token_id=token_id, upkept=1)
