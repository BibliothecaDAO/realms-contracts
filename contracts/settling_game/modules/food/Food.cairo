...
func get_farms_to_harvest{
    ...
    total_harvest: felt, total_remaining: felt, decayed_farms: felt, farms_built: felt
) {
    alloc_locals;
...
func get_fishing_villages_to_harvest{
    ...
    total_harvest: felt, total_remaining: felt, decayed_farms: felt, villages_built: felt
) {
    alloc_locals;
    // farm expirary time
    let (block_timestamp) = get_block_timestamp();
...
func get_all_food_information{
    ...
    total_farm_harvest: felt,
    total_farm_remaining: felt,
    decayed_farms: felt,
    farms_built: felt,
    farm_harvests_left: felt,
    total_village_harvest: felt,
    total_village_remaining: felt,
    decayed_villages: felt,
    villages_built: felt,
    fishing_villages_harvests_left: felt,
) {
    alloc_locals;
    // farm expirary time
