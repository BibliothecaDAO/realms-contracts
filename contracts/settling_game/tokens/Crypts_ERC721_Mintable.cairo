...
func fetch_crypt_data{
    ...
    let (resource) = unpack_data(data, 0, 255)      # [0-4] uint256 - resource generated by this dungeon (23-28)
    let (environment) = unpack_data(data, 6, 255)   # [5-7] uint256 - environment of the dungeon (0-6)
    let (legendary) = unpack_data(data, 8, 255)     # [8] uint256 - flag if dungeon is legendary (0/1)
    ...
    let (affinity) = unpack_data(data, 22, 255)     # [22-27] uint256 - affinity of this dungeon (0-55)
