...
# FOOD
const FOOD_CYCLE_LENGTH = 24
const FARM_LENGTH = DAY * FOOD_CYCLE_LENGTH
const FISHING_TRAPS = DAY * FOOD_CYCLE_LENGTH

const BASE_FOOD_PRODUCTION = 2000

const BASE_HARVESTS = 24

const MAX_HARVEST_LENGTH = 12
