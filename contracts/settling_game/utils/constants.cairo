...
const BASE_RESOURCES_PER_DAY = 252;  // base resource production per day cycle
const BASE_RESOURCES_PER_CYCLE = BASE_RESOURCES_PER_DAY / 12;
const WONDER_RATE = BASE_RESOURCES_PER_DAY / 10;  // resources generated by wonders set at 10% of regular realm

const VAULT_LENGTH = 4;  // length of day cycles
