...
func ERC721_Enumerable_tokenByIndex{
        syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(index : Uint256) -> (
        token_id : Uint256):
    alloc_locals
    uint256_check(index)
...
func ERC721_Enumerable_mint{pedersen_ptr : HashBuiltin*, syscall_ptr : felt*, range_check_ptr}(
...
func ERC721_Enumerable_burn{pedersen_ptr : HashBuiltin*, syscall_ptr : felt*, range_check_ptr}(
        token_id : Uint256):
...
func _add_token_to_all_tokens_enumeration{
        pedersen_ptr : HashBuiltin*, syscall_ptr : felt*, range_check_ptr}(token_id : Uint256):
    alloc_locals
