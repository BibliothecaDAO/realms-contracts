...
struct RealmData:
    member cites : felt  # low to high, [0, 10]. 0=None.
    member regions : felt  # low to high, [0, 10]. 0=None.
    member rivers : felt  # low to high, [0, 10]. 0=None.
    member harbours : felt  # low to high, [0, 10]. 0=None.
    member resource_1 : felt  # low to high, [0, 10]. 0=None.
    member resource_2 : felt  # NFT drug item [0, 10]. 0=None.
end
...
func fetch_realm_data{
    ...
    let (local cites) = unpack_realm_data(realm_id, 0)
