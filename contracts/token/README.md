...
This folder contains standard token contracts (ERC1155, ERC20, ERC721) for Cairo/Starknet.

**This folder contains Standard Token contracts. If you're looking for another contract, please see the [directory of our Realms Smart Contracts](/).**

### Token contracts overview

| Module          | Function                             | Current Status |
| --------------- | ------------------------------------ | -------------- |
| [ERC20](./ERC20.cairo) | ERC20 contract | In progress |
| [ERC1155](./ERC1155/ERC1155_base.cairo) | ERC1155 contract | In progress |
| [ERC721](./ERC721.cairo) | ERC721 contract | In progress |

*Note: There are extensions (e.g. Enumerable, Mintable) for each contract in the `./token` folder.*
<hr>
...
- TODO: Add contract descriptions here
