...
MODULE_CONTRACT_IMPLEMENTATIONS = [
    ModuleContracts(
        "poaps/crowns/LisbonCrown", "LisbonCrown", 0)
]
...
def run(nre):
    ...
    #     # compile(
    #     #     contract_alias="contracts/poaps/crowns/LisbonCrown")
    ...
    # #---------------- INIT MODULES  ----------------#
    NAME = str_to_felt("The Lost Caravan")
    for contract in MODULE_CONTRACT_IMPLEMENTATIONS:
        ...
        wrapped_send(
            ...
            arguments=[
                NAME, NAME, config.ADMIN_ADDRESS],
        )
