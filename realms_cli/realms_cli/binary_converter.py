...
def map_crypt(value, environments):
    environment = None
    legendary = None
    ...
    resourceIds = [23 + int(environment)]   # Crypts resources are 23->28. Environments start at id 0 in our json.
    ...
    legendary = [value["legendary"]]  # 1 is true, 0 is false
...
if __name__ == '__main__':
    ...
    for index in range(10):
        ...
        map_crypt(crypts["dungeons"][index], environments)
        print("\n")
