...
func test_set_metadata{
    ...
    %{
        ...
        assert string_data == 'data:application/json,{"description":"realms","name":Test 1,"image":"https://d23fdhqc1jb9no.cloudfront.net/_Realms/1.svg","attributes":[{"trait_type":"Regions","value":"4"},{"trait_type":"Cities","value":"5"},{"trait_type":"Harbors","value":"2"},{"trait_type":"Rivers","value":"1"},{"trait_type":"Resource","value":"Stone"},{"trait_type":"Resource","value":"ColdIron"},{"trait_type":"Resource","value":"Ruby"},{"trait_type":"Resource","value":"Silver"},{"trait_type":"Wonder (translated)","value":"Cathedral Of Agony"},{"trait_type":"Order","value":"Skill"}]}'
    %}
    ...
    %{
        ...
        for i in range(ids.data_2_len):
            ...
            array.append(path.to_bytes(31, "big").decode())
        string_data = ''.join(array).replace('\x00', '')
        assert string_data == 'data:application/json,{"description":"realms","name":Test 2,"image":"https://realms-assets.s3.eu-west-3.amazonaws.com/renders/2.webp","attributes":[{"trait_type":"Regions","value":"2"},{"trait_type":"Cities","value":"3"},{"trait_type":"Harbors","value":"6"},{"trait_type":"Rivers","value":"4"},{"trait_type":"Resource","value":"Wood"},{"trait_type":"Resource","value":"Obsidian"},{"trait_type":"Resource","value":"Stone"},{"trait_type":"Resource","value":"Gold"},{"trait_type":"Resource","value":"DeepCrystal"},{"trait_type":"Resource","value":"Hartwood"},{"trait_type":"Order","value":"Reflection"}]}'
    %}
    return ();
}