...
func test_fetch_trade_data{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() {
    ...
    let (trade: Trade) = NFT_Marketplace.fetch_trade_data(
        contract_address=contract_address,
        trade_data=trade_data,
        price=price,
        poster=contract_address,
    );
    ...
    let (packed_trade_data: felt) = NFT_Marketplace.pack_trade_data(
        contract_address=contract_address, trade=trade
    );
